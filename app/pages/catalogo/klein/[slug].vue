    ...
    <div class="min-h-screen bg-white">
        <UContainer class="py-8 md:py-12 xl:py-16">
            ...
            <nav class="flex items-center gap-2 text-xs uppercase tracking-widest text-stone-400 mb-8">
                ...
                <span>/</span>
                <NuxtLink to="/catalogo/klein" class="hover:text-red-600 transition-colors">KLEIN TOOLS</NuxtLink>
                <span>/</span>
...
useSeoMeta({
    title: () => selectedSub.value
        ? `${selectedSub.value.name} | ${category.value?.name} | KLEIN — APCO Tools`
        : `${category.value?.name} | KLEIN — APCO Tools`,
})
</script>